...
| **Từ chối không mang tính trừng phạt** | Từ chối trơ trọi, không lý do, đọc như quở trách | Mỗi từ chối có lý do ngắn và bước tiếp theo, giữ giọng hội thoại ([08](08-ux.md) §6) |
...
| **Hành động tiếp theo** | Đầu ra là bàn đạp cho việc kế tiếp | "Áp vào form tính toán" (điền tham số vào trang) để pha sau; 8 tuần chỉ có Duyệt, mở nguồn, sao chép |
