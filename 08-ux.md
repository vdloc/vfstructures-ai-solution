...
> **Đã cập nhật trong `ship/`.** File này ghi thiết kế giao diện trước lượt rà soát 21/09/2026. Bản đã sửa: `ship/07-giao-dien.md`. Từ AD-28 (22/09/2026), case tự ghi khi engine tính đạt và không còn bước duyệt: xem `ship/12-tra-case.md`.
