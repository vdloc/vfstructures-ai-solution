...
**Nguồn:** toàn bộ nội dung kỹ thuật trong tài liệu này lấy từ bộ `ship/` (13 file, bản chính thức đã bàn giao), đã đối chiếu trực tiếp với tài liệu AWS và sách chuyên ngành trong đợt rà soát gần nhất (21/09/2026). Tài liệu này là bản trình bày lại cho đối tượng đọc doanh nghiệp — khi có xung đột về chi tiết kỹ thuật, `ship/` là nguồn đúng.
...
Toàn bộ quyết định kỹ thuật trong tài liệu này đối chiếu với tài liệu chính thức AWS (fetch trực tiếp, ngày 18–21/09/2026) và các sách chuyên ngành về kiến trúc AI doanh nghiệp, RAG production, và Amazon Bedrock — danh sách đầy đủ kèm ngày fetch nằm ở `ship/00-thuat-ngu-va-nguon.md`.

### 13.3 Đọc sâu hơn

Bộ tài liệu kỹ thuật đầy đủ (13 file, bản chính thức) nằm tại thư mục `ship/`, bắt đầu từ [`ship/README.md`](ship/README.md) (mục lục, thứ tự đọc theo vai trò). Liên quan trực tiếp tới từng mục của hồ sơ này:

| Mục hồ sơ này | File `ship/` tương ứng |
| --- | --- |
| 1–2 (bài toán, khái niệm nền) | [ship/11-thuyet-minh.md](ship/11-thuyet-minh.md) |
| 3 (kiến trúc kỹ thuật) | [ship/01-kien-truc.md](ship/01-kien-truc.md), [ship/03-backend.md](ship/03-backend.md) |
| 4 (mô hình vận hành, quản trị) | [ship/06-bao-mat.md](ship/06-bao-mat.md), [ship/10-rui-ro.md](ship/10-rui-ro.md) §2 (chủ sở hữu) |
| 5 (vòng đời tri thức) | [ship/02-hop-dong.md](ship/02-hop-dong.md), [ship/03-backend.md](ship/03-backend.md) |
| 6 (khung đánh giá AI) | [ship/08-eval-quan-sat.md](ship/08-eval-quan-sat.md) |
| 8 (triển khai AWS) | [ship/05-devops.md](ship/05-devops.md), [ship/09-trien-khai.md](ship/09-trien-khai.md) |
| 9 (chi phí) | [ship/11-thuyet-minh.md](ship/11-thuyet-minh.md) Phần 9b, [ship/00-thuat-ngu-va-nguon.md](ship/00-thuat-ngu-va-nguon.md) |
| 10–11 (rủi ro, câu hỏi mở) | [ship/10-rui-ro.md](ship/10-rui-ro.md) |

Khi có xung đột chi tiết giữa hồ sơ này và `ship/`, `ship/` là nguồn đúng.
